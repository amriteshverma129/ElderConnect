    ...
    return (
        <div className="layout-container-fluid">
            <div className={styles["privacyPolicy"]}>
                <div className={styles["privacyPolicy-heading"]}>Privacy policy</div>
                <div className={styles["privacyPolicy-para"]}>
                    This privacy policy (“Policy”) describes how the personally identifiable information (“Personal
                    Information”) you may provide on the theloopvillage.com website (“Website” or “Service”) and any of
                    ...
                    <br />
                    <br />
                    This Policy is a legally binding agreement between you (“User”, “you” or “your”) and LOOP Village
                    Inc (“LOOP Village Inc”, “we”, “us” or “our”). By accessing and using the Website and Services, you
                    acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This
                    Policy does not apply to the practices of companies that we do not own or control, or to individuals
                    that we do not employ or manage.
                </div>
                <div className={styles["privacyPolicy-heading"]}>Automatic collection of information</div>
                <div className={styles["privacyPolicy-para"]}>
                    Our top priority is customer data security and, as such, we exercise the no logs policy. We may
                    process only minimal user data, only as much as it is absolutely necessary to maintain the Website
                    and Services. Information collected automatically is used only to identify potential cases of abuse
                    and establish statistical information regarding the usage and traffic of the Website and Services.
                ...
                <div className={styles["privacyPolicy-heading"]}>Collection of personal information</div>
                <div className={styles["privacyPolicy-para"]}>
                    You can access and use the Website and Services without telling us who you are or revealing any
                    ...
                    knowingly provide to us when you make a purchase, or fill any online forms on the Website. When
                    ...
                    Some of the information we collect is directly from you via the Website and Services. However, we
                ...
                <div className={styles["privacyPolicy-heading"]}>Use and processing of collected information</div>
                <div className={styles["privacyPolicy-para"]}>
                    In order to make the Website and Services available to you, or to meet a legal obligation, we may
                    ...
                    Processing your Personal Information depends on how you interact with the Website and Services,
                    where you are located in the world and if one of the following applies: <br />
                    <br />
                    <ul>
                        <li>
                            you have given your consent for one or more specific purposes; this, however, does not
                            apply, whenever the processing of Personal Information is subject to California Consumer
                            Privacy Act or European data protection law;
                        </li>
                        <li>
                            provision of information is necessary for the performance of an agreement with you and/or
                ...
                <div className={styles["privacyPolicy-heading"]}>Billing and payments</div>
                <div className={styles["privacyPolicy-para"]}>
                    We use third party payment processors to assist us in processing your payment information securely.
                    Such third party processors’ use of your Personal Information is governed by their respective
                    privacy policies which may or may not contain privacy protections as protective as this Policy. We
                    suggest that you review their respective privacy policies.
                </div>
                <div className={styles["privacyPolicy-heading"]}>Disclosure of information</div>
                <div className={styles["privacyPolicy-para"]}>
                    ...
                    <br />
                    <br /> These service providers are not authorized to use or disclose your information except as
                    necessary to perform services on our behalf or comply with legal requirements. We may share your
                    Personal Information for these purposes only with third parties whose privacy policies are
                    consistent with ours or who agree to abide by our policies with respect to Personal Information.
                    These third parties are given Personal Information they need only in order to perform their
                    designated functions, and we do not authorize them to use or disclose Personal Information for their
                ...
                <div className={styles["privacyPolicy-heading"]}>Retention of information</div>
                <div className={styles["privacyPolicy-para"]}>
                ...
                <div className={styles["privacyPolicy-heading"]}>Transfer of information</div>
                <div className={styles["privacyPolicy-para"]}>
                ...
                <div className={styles["privacyPolicy-heading"]}>The rights of users</div>
                <div className={styles["privacyPolicy-para"]}>
                    ...
                    <ul>
                        <li>
                            you have the right to withdraw consent where you have previously given your consent to the
                            processing of your information;
                        </li>
                        <li>
                            you have the right to object to the processing of your information if the processing is
                            carried out on a legal basis other than consent;
                        </li>
                        <li>
                            you have the right to learn if information is being processed by us, obtain disclosure
                            regarding certain aspects of the processing and obtain a copy of the information undergoing
                            processing;
                        </li>
                        <li>
                            you have the right to verify the accuracy of your information and ask for it to be updated
                            or corrected;
                        </li>
                        <li>
                            you have the right, under certain circumstances, to restrict the processing of your
                            information, in which case, we will not process your information for any purpose other than
                            storing it;
                        </li>
                        <li>
                            you have the right, under certain circumstances, to obtain the erasure of your Personal
                            Information from us;
                        </li>
                        <li>
                            {" "}
                            you have the right to receive your information in a structured, commonly used and machine
                            readable format and, if technically feasible, to have it transmitted to another controller
                            without any hindrance. This provision is applicable provided that your information is
                            processed by automated means and that the processing is based on your consent, on a contract
                            which you are part of or on pre-contractual obligations thereof.
                        </li>
                    </ul>
                </div>
                <div className={styles["privacyPolicy-heading"]}>The right to object to processing</div>
                <div className={styles["privacyPolicy-para"]}>
                    Where Personal Information is processed for the public interest, in the exercise of an official
                ...
                <div className={styles["privacyPolicy-heading"]}>Data protection rights under GDPR</div>
                <div className={styles["privacyPolicy-para"]}>
                    If you are a resident of the European Economic Area (EEA), you have certain data protection rights
                    and LOOP Village Inc aims to take reasonable steps to allow you to correct, amend, delete, or limit
                    the use of your Personal Information. If you wish to be informed what Personal Information we hold
                    about you and if you want it to be removed from our systems, please contact us. In certain
                    circumstances, you have the following data protection rights:
                    <br />
                    <br />
                    <ul>
                        <li>
                            You have the right to request access to your Personal Information that we store and have the
                            ability to access your Personal Information.
                        </li>
                        <li>
                            You have the right to request that we correct any Personal Information you believe is
                            inaccurate. You also have the right to request us to complete the Personal Information you
                            believe is incomplete.
                        </li>
                        <li>
                            You have the right to request the erase your Personal Information under certain conditions
                            of this Policy.
                        </li>
                        <li>You have the right to object to our processing of your Personal Information.</li>
                        <li>
                            You have the right to seek restrictions on the processing of your Personal Information. When
                            you restrict the processing of your Personal Information, we may store it but will not
                            process it further.
                        </li>
                        <li>
                        ...
                        <li>
                            You also have the right to withdraw your consent at any time where LOOP Village Inc relied
                ...
                <div className={styles["privacyPolicy-heading"]}>California privacy rights</div>
                <div className={styles["privacyPolicy-para"]}>
                ...
                <div className={styles["privacyPolicy-heading"]}>How to exercise these rights</div>
                <div className={styles["privacyPolicy-para"]}>
                    Any requests to exercise your rights can be directed to LOOP Village Inc through the contact details
                    provided in this document. Please note that we may ask you to verify your identity before responding
                    to such requests. Your request must provide sufficient information that allows us to verify that you
                    are the person you are claiming to be or that you are the authorized representative of such person.
                    You must include sufficient details to allow us to properly understand the request and respond to
                    it. We cannot respond to your request or provide you with Personal Information unless we first
                    verify your identity or authority to make such a request and confirm that the Personal Information
                    relates to you.
                </div>
                <div className={styles["privacyPolicy-heading"]}>Privacy of children</div>
                <div className={styles["privacyPolicy-para"]}>
                    We do not knowingly collect any Personal Information from children under the age of 18. If you are
                    under the age of 18, please do not submit any Personal Information through the Website and Services.
                    ...
                    age of 18 has provided Personal Information to us through the Website and Services, please contact
                ...
                <div className={styles["privacyPolicy-heading"]}>Cookies</div>
                <div className={styles["privacyPolicy-para"]}>
                    The Website and Services use “cookies” to help personalize your online experience. A cookie is a
                    ...
                    <br />
                    <br />
                    We may use cookies to collect, store, and track information for statistical purposes to operate the
                    ...
                    you prefer. You may learn more about cookies and how they work here.
                </div>
                <div className={styles["privacyPolicy-heading"]}>Do Not Track signals</div>
                <div className={styles["privacyPolicy-para"]}>
                    Some browsers incorporate a Do Not Track feature that signals to websites you visit that you do not
                ...
                <div className={styles["privacyPolicy-heading"]}>Email marketing</div>
                <div className={styles["privacyPolicy-para"]}>
                    We offer electronic newsletters to which you may voluntarily subscribe at any time. We are committed
                    to keeping your e-mail address confidential and will not disclose your email address to any third
                    parties except as allowed in the information use and processing section or for the purposes of
                    utilizing a third party provider to send such emails. We will maintain the information sent via
                ...
                <div className={styles["privacyPolicy-heading"]}>Links to other resources</div>
                <div className={styles["privacyPolicy-para"]}>
                ...
                <div className={styles["privacyPolicy-heading"]}>Information security</div>
                <div className={styles["privacyPolicy-para"]}>
                    ...
                    <ul>
                        ...
                        <li>
                            the security, integrity, and privacy of any and all information and data exchanged between
                            you and the Website and Services cannot be guaranteed; and
                        </li>
                        <li>
                ...
                <div className={styles["privacyPolicy-heading"]}>Data breach</div>
                <div className={styles["privacyPolicy-para"]}>
                    In the event we become aware that the security of the Website and Services has been compromised or
                    ...
                    law. When we do, we will post a notice on the Website, send you an email.
                </div>
                <div className={styles["privacyPolicy-heading"]}>Changes and amendments</div>
                <div className={styles["privacyPolicy-para"]}>
                    We reserve the right to modify this Policy or its terms relating to the Website and Services from
                ...
                <div className={styles["privacyPolicy-heading"]}>Acceptance of this policy</div>
                <div className={styles["privacyPolicy-para"]}>
                ...
                <div className={styles["privacyPolicy-heading"]}>Contacting us</div>
                <div className={styles["privacyPolicy-para"]}>
                    If you would like to contact us to understand more about this Policy or wish to contact us
                    concerning any matter relating to individual rights and your Personal Information, you may send an
                    email to info@theloopvillage.com.
                    <br />
