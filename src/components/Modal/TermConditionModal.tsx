...
export default function TermConditionModal(props: TermConditionModalProps) {
                ...
                <div className={styles["termCondition"]}>
                    <div className={styles["termCondition-pop-up"]}>
                        <div className={styles["termCondition-heading-cross-holder"]}>
                            <div className={styles["termCondition-heading"]}>Terms and Conditons</div>
                        ...
                        <div style={{ maxHeight: "450px", minHeight: "300px", width: "100%", overflowY: "scroll" }}>
                            <div className={styles["termCondition-rule"]}>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    of your use of the theloopvillage.com website (“Website” or “Service”) and any of
                                    its related products and services (collectively, “Services”). This Agreement is
                                    legally binding between you (“User”, “you” or “your”) and LOOP Village Inc (“LOOP
                                    Village Inc”, “we”, “us” or “our”). By accessing and using the Website and Services,
                                    ...
                                    this Agreement, you must not accept this Agreement and may not access and use the
                                    Website and Services. You acknowledge that this Agreement is a contract between you
                                    and LOOP Village Inc, even though it is electronic and is not physically signed by
                                    you, and it governs your use of the Website and Services.
                                </div>
                                <div className={styles["termCondition-title"]}>Accounts and membership</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    that you are at least 18 years of age. If you create an account on the Website, you
                                    are responsible for maintaining the security of your account and you are fully
                                    responsible for all activities that occur under the account and any other actions
                                    taken in connection with it. We may monitor and review new accounts before you may
                                    sign in and start using the Services.
                                    <br />
                                    <br /> Providing false contact information of any kind may result in the termination
                                    of your account. You must immediately notify us of any unauthorized uses of your
                                    account or any other breaches of security. We will not be liable for any acts or
                                    omissions by you, including any damages of any kind incurred as a result of such
                                    acts or omissions. We may suspend, disable, or delete your account (or any part
                                ...
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    enabled for the Services you have subscribed for, you will be charged automatically
                                    in accordance with the term you selected. If, in our judgment, your purchase
                                    constitutes a high-risk transaction, we will require you to provide us with a copy
                                    of your valid government-issued photo identification, and possibly a copy of a
                                    recent bank statement for the credit or debit card used for the purchase. We reserve
                                    the right to change products and product pricing at any time. <br />
                                    <br />
                                    We also reserve the right to refuse any order you place with us. We may, in our sole
                                ...
                                <div className={styles["termCondition-title"]}>Accuracy of information</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    any information on the Website or Services is inaccurate at any time without prior
                                    notice (including after you have submitted your order). We undertake no obligation
                                    to update, amend or clarify information on the Website including, without
                                    limitation, pricing information, except as required by law. No specified update or
                                    refresh date applied on the Website should be taken to indicate that all information
                                    on the Website or Services has been modified or updated.
                                </div>
                                <div className={styles["termCondition-title"]}>Third party services</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    including, without limitation, their content or the manner in which they handle data
                                    (including your data) or any interaction between you and the provider of such other
                                    services. You irrevocably waive any claim against LOOP Village Inc with respect to
                                    such other services.
                                    <br />
                                    <br /> LOOP Village Inc is not liable for any damage or loss caused or alleged to be
                                    caused by or in connection with your enablement, access or use of any such other
                                    services, or your reliance on the privacy practices, data security processes or
                                    other policies of such other services. You may be required to register for or log
                                    into such other services on their respective platforms. By enabling any other
                                    services, you are expressly permitting LOOP Village Inc to disclose your data as
                                ...
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    resource, unless specifically stated herein. Some of the links on the Website may be
                                    “affiliate links”. This means if you click on the link and purchase an item, LOOP
                                    Village Inc will receive an affiliate commission. We are not responsible for
                                    examining or evaluating, and we do not warrant the offerings of, any businesses or
                                    individuals or the content of their resources. We do not assume any responsibility
                                    ...
                                    use of any resource which you access through a link on the Website and Services.
                                    Your linking to any other off-site resources is at your own risk.
                                </div>
                                <div className={styles["termCondition-title"]}>Prohibited uses</div>
                                <div className={styles["termCondition-para"]}>
                                    In addition to other terms as set forth in the Agreement, you are prohibited from
                                    using the Website and Services or Content:
                                    <br />
                                    <br />
                                    <ul>
                                        ...
                                        <li>
                                            to upload or transmit viruses or any other type of malicious code that will
                                ...
                                <div className={styles["termCondition-title"]}>Intellectual property rights</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    off, rights to inventions, rights to use, and all other intellectual property
                                    rights, in each case whether registered or unregistered and including all
                                    applications and rights to apply for and be granted, rights to claim priority from,
                                    such rights and all similar or equivalent rights or forms of protection and any
                                    other results of intellectual activity which subsist or will subsist now or in the
                                    future in any part of the world. <br />
                                    <br />
                                    This Agreement does not transfer to you any intellectual property owned by LOOP
                                    Village Inc or third parties, and all rights, titles, and interests in and to such
                                    property will remain (as between the parties) solely with LOOP Village Inc. All
                                    trademarks, service marks, graphics and logos used in connection with the Website
                                    and Services, are trademarks or registered trademarks of LOOP Village Inc or its
                                    licensors. Other trademarks, service marks, graphics and logos used in connection
                                    with the Website and Services may be the trademarks of other third parties. Your use
                                    of the Website and Services grants you no right or license to reproduce or otherwise
                                    use any of LOOP Village Inc or third party trademarks.
                                </div>
                                <div className={styles["termCondition-title"]}>Disclaimer of warranty</div>
                                <div className={styles["termCondition-para"]}>
                                    You agree that such Service is provided on an “as is” and “as available” basis and
                                    that your use of the Website and Services is solely at your own risk. We expressly
                                    ...
                                    <br />
                                    <br /> You understand and agree that any material and/or data downloaded or
                                    otherwise obtained through the use of Service is done at your own discretion and
                                    risk and that you will be solely responsible for any damage or loss of data that
                                ...
                                <div className={styles["termCondition-title"]}>Limitation of liability</div>
                                <div className={styles["termCondition-para"]}>
                                    To the fullest extent permitted by applicable law, in no event will LOOP Village
                                    Inc, its affiliates, directors, officers, employees, agents, suppliers or licensors
                                    ...
                                    of statutory duty, negligence or otherwise, even if the liable party has been
                                    advised as to the possibility of such damages or could have foreseen such damages.
                                    <br />
                                    <br />
                                    To the maximum extent permitted by applicable law, the aggregate liability of LOOP
                                    Village Inc and its affiliates, officers, employees, agents, suppliers and licensors
                                    relating to the services will be limited to an amount greater of one dollar or any
                                    amounts actually paid in cash by you to LOOP Village Inc for the prior one month
                                ...
                                <div className={styles["termCondition-title"]}>Indemnification</div>
                                <div className={styles["termCondition-para"]}>
                                    You agree to indemnify and hold LOOP Village Inc and its affiliates, directors,
                                ...
                                <div className={styles["termCondition-title"]}>Severability</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    render this Agreement illegal, invalid or unenforceable. If any provision or portion
                                ...
                                <div className={styles["termCondition-title"]}>Dispute resolution</div>
                                <div className={styles["termCondition-para"]}>
                                    ...
                                    California, United States without regard to its rules on conflicts or choice of law
                                    and, to the extent applicable, the laws of United States. The exclusive jurisdiction
                                    and venue for actions related to the subject matter hereof shall be the courts
                                    located in California, United States, and you hereby submit to the personal
                                ...
                                <div className={styles["termCondition-title"]}>Assignment</div>
                                <div className={styles["termCondition-para"]}>
                                    You may not assign, resell, sub-license or otherwise transfer or delegate any of
                                    your rights or obligations hereunder, in whole or in part, without our prior written
                                    consent, which consent shall be at our own sole discretion and without obligation;
                                    any such assignment or transfer shall be null and void. We are free to assign any of
                                    its rights or obligations hereunder, in whole or in part, to any third party as part
                                    of the sale of all or substantially all of its assets or stock or as part of a
                                    merger.
                                </div>
                                <div className={styles["termCondition-title"]}>Changes and amendments</div>
                                <div className={styles["termCondition-para"]}>
                                    We reserve the right to modify this Agreement or its terms relating to the Website
                                    and Services at any time, effective upon posting of an updated version of this
                                    Agreement on the Website. When we do, we will revise the updated date at the bottom
                                    of this page. Continued use of the Website and Services after any such changes shall
                                    constitute your consent to such changes.
                                </div>
                                <div className={styles["termCondition-title"]}>Acceptance of these terms</div>
                                <div className={styles["termCondition-para"]}>
                                    You acknowledge that you have read this Agreement and agree to all its terms and
                                    conditions. By accessing and using the Website and Services you agree to be bound by
                                    this Agreement. If you do not agree to abide by the terms of this Agreement, you are
