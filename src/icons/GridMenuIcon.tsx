interface GridMenuIconColor {
    strokecolor: string;
}

function GridMenuIcon({ strokecolor = "#142c60" }: GridMenuIconColor) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="-0.5 0 25 25" fill="none">
            <path
