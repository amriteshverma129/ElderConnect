const usc24HoursReminderMail = (name: string): string => {
    return `
    <!DOCTYPE html>
                                                                ...
                                                                <td align="left" style="padding: 0;">
                                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                                        <p style="margin: 0;font-family:'Poppins',sans-serif; font-weight: 600;font-size: 20px; line-height: 32px; color: #142C60;; mso-line-height-alt: 24px;">
                                                                            This is your 24-hours reminder for LOOP/USC/LADOA’s The Power of Food Preparation. 1-hour before we will send the link to the program.
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
...
export default usc24HoursReminderMail;
