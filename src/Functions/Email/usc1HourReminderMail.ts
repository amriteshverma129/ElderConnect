const usc1HourReminderMail = (name: string, link: string): string => {
    return `
    <!DOCTYPE html>
                                                ...
                                                <tr>
                                                    <td class="column column-1"
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="pad" style="width:100%;">
                                                                    <h2 align="left" style="font-family:'Poppins',sans-serif;font-weight: 500;font-size: 24px; line-height: 35px; color: #142C60; padding-left: 20px; padding-right: 20px; margin: 0;">Today’s the day!</h2>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td class="pad"
                                                                    ...
                                                                    <div align="center" class="alignment">
                                                                        <img src="https://images.prismic.io/loop-web-members/f39b9434-8465-4c97-a0d1-318a0e33bcd74_Food+Prep.png?auto=compress,format" alt="LOOP Village" width="100%" height="100%" style="width:100%;max-height:320px;border-radius:12px;object-fit:cover;">
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>                                                    
                                                                ...
                                                                <td align="left" style="padding: 0;">
                                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                                        <p style="margin: 0;font-family:'Poppins',sans-serif; font-weight: 600;font-size: 20px; line-height: 32px; color: #142C60;; mso-line-height-alt: 24px;">
                                                                            LOOP/USC/LADOA’s The Power of Food Preparation will begin in 1 hour.
                                                                        </p>
                                                                    </div>
                                                                    <div class="spacer_block block-8" style="height:20px;line-height:80px;font-size:1px;"> </div>
                                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                                        <a href=${link} style="display: block;width: 100%;padding: 12px 0;text-align: center;font-family:'Poppins',sans-serif;font-size: 20px;font-weight: 700;line-height: 32px;color: #ffffff;background-color: #D92D3E;border-radius: 6px;">Click the HERE to join this event!</a>    
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                ...
                                                                <td align="left" style="padding: 0;">
                                                                    <div style="padding-left: 20px; padding-right: 20px;">
                                                                        <p style="margin: 0;font-family:'Poppins',sans-serif; font-weight: 400;font-size: 20px; line-height: 32px; color: #142C60; mso-line-height-alt: 24px;">
                                                                            The Zoom will open 10 minutes before the class begins.
                                                                        </p>
                                                                    </div>
                                                                    <div class="spacer_block block-5" style="height:20px;line-height:20px;font-size:1px;"> </div>
                                                                    <div style="padding-left: 20px; padding-right: 20px;">
...
export default usc1HourReminderMail;
