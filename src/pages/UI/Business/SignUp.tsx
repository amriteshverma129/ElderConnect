...
const SignUp: NextPage = () => {
    ...
    const handleChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (name === "partnerCode") {
            if (value === "") {
                setError({ ...error, partnerErrorMessage: "Referral Code can not be Empty" });
            ...
            if (!roleList.some((roleObj) => roleObj.partnerCode === value.trim().toLowerCase())) {
                setError({ ...error, partnerErrorMessage: "Referral code is incorrect." });
            } else {
    ...
    useEffect(() => {
        if (
            ...
            form.TermCondition !== "" &&
            form.partnerCode !== "" &&
            form.nameOfBusiness?.trim() !== "" &&
            error.partnerErrorMessage === "" &&
            error.firstNameErrorMessage === "" &&
            error.lastNameErrorMessage === "" &&
            error.nameOfBusinessErrorMessage === "" &&
            ((form.email !== "" &&
                form.password !== "" &&
                        ...
                        {!otpPage ? (
                            <div>
                                ...
                                <InputField
                                    ...
                                    name="nameOfBusiness"
                                    type="text"
                                    value={toCapitalizeLetter(form.nameOfBusiness)}
                                    placeholder="Enter business name"
                                    handleChange={handleChange}
                                    label="Business Name"
                                    errorMessage={error.nameOfBusinessErrorMessage}
                                    required={true}
                                />
                                <InputField
                                    id="firstName"
